...
class BenjaminWP_Bootstrap {
    ...
    function setup_theme() {
        ...
        load_theme_textdomain( 'BenjaminWP', get_template_directory() . '/languages' );
        ...
        register_nav_menus( array(
            'primary' => __( 'Primary Menu', 'BenjaminWP' ),
        ) );
    ...
    function footer_scripts() {
        $css = BenjaminWP_get_option( 'footer_css', 'tp_settings' );
        $js = BenjaminWP_get_option( 'footer_js', 'tp_settings' );
...
$BenjaminWP_bootstrap = new BenjaminWP_Bootstrap();
 ...
 * @return mixed
 */
function BenjaminWP_get_option( $option, $section, $default = '' ) {
